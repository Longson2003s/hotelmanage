...
public class GUIMenu extends JFrame implements ActionListener {
	...
	public GUIMenu(int check) {
		...
		menuBar.add(lbNhanVien = new JLabel("Nguyễn Văn A"));
		...
		JMenuItem meimThoat = new JMenuItem("Thoát", new ImageIcon(".\\image\\exit.png"));
		...
		//Nút con Dịch Vụ
		meimCapNhatDichVu = new JMenuItem("Cập Nhật", new ImageIcon(".\\image\\employees.png"));
		...
		//Nút Con Phòng
		meimDatTraPhong = new JMenuItem("Đặt - Trả Phòng", new ImageIcon(".\\image\\booking.png"));
		...
		// FOORTER
		JLabel lbHieu, lbDang, lbLinh, lbMaHieu, lbMaDang, lbMaLinh;
		bc.add(b1 = Box.createHorizontalBox());
			...
			b3.add(lbHieu = new JLabel("Nguyễn Văn A (Nhóm Trưởng)"));
			b3.add(Box.createHorizontalStrut(20));
			b3.add(lbMaHieu = new JLabel("17087871"));
			b2.add(Box.createVerticalStrut(20));
			b2.add(b3 = Box.createHorizontalBox());
			b3.add(Box.createHorizontalStrut(20));
			b3.add(lbDang = new JLabel("Nguyễn Văn B"));
			b3.add(Box.createHorizontalStrut(20));
			b3.add(lbMaDang = new JLabel("17100261"));
			b2.add(Box.createVerticalStrut(20));
			b2.add(b3 = Box.createHorizontalBox());
			b3.add(Box.createHorizontalStrut(20));
			b3.add(lbLinh = new JLabel("Nguyễn Văn C"));
			b3.add(Box.createHorizontalStrut(20));
			b3.add(lbMaLinh = new JLabel("17094931"));
			b2.add(Box.createVerticalStrut(50));
			b1.add(Box.createHorizontalStrut(width-1420));
			setFontLabel(Arrays.asList(lbDang,lbHieu,lbLinh,lbMaDang,lbMaHieu,lbMaLinh,lbNhanVien,lbNgayHienTai));
